...
export default class {
  ...
  handleShowTickets(e, bills, index) {
    // si le compteur est undefined ou que l'index est différent de l'index en paramètre, alors le compteur est égal à 0 (c'est le premier clic sur l'icone flèche) sinon le compteur est égal à 1 (c'est le deuxième clic sur l'icone flèche) et on cache la liste des factures (bills) et on affiche l'icone flèche vers le bas
